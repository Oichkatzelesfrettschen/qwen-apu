BB0:
	...
	v_and_b32_e32 v3, 15, v2                                    ; 2606048f
	v_lshrrev_b32_e32 v5, 4, v2                                 ; 200a0484
	v_and_b32_e32 v2, 0xf0f0f0f, v2                             ; 260404ff 0f0f0f0f
	v_cvt_f32_u32_e32 v3, v3                                    ; 7e060d03
	v_and_b32_e32 v6, 15, v5                                    ; 260c0a8f
	v_and_b32_e32 v5, 0xf0f0f0f, v5                             ; 260a0aff 0f0f0f0f
	v_bfe_u32 v7, v2, 8, 4                                      ; d1c80007 02111102
	v_bfe_u32 v10, v2, 16, 4                                    ; d1c8000a 02112102
	v_cvt_f16_f32_e32 v4, v3                                    ; 7e081503
	v_cvt_f32_ubyte3_e32 v2, v2                                 ; 7e042902
	v_cvt_f32_u32_e32 v6, v6                                    ; 7e0c0d06
	v_bfe_u32 v12, v5, 16, 4                                    ; d1c8000c 02112105
	v_bfe_u32 v9, v5, 8, 4                                      ; d1c80009 02111105
	v_cvt_f32_u32_e32 v7, v7                                    ; 7e0e0d07
	v_cvt_f32_ubyte3_e32 v5, v5                                 ; 7e0a2905
	v_cvt_f32_u32_e32 v10, v10                                  ; 7e140d0a
	s_waitcnt vmcnt(0)                                          ; bf8c3f70
	v_cvt_f32_i32_sdwa v14, sext(v1) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_0 ; 7e1c0af9 00080601
	v_cvt_f16_f32_e32 v13, v2                                   ; 7e1a1502
	v_cvt_f16_f32_sdwa v4, v6 dst_sel:WORD_1 dst_unused:UNUSED_PRESERVE src0_sel:DWORD ; 7e0814f9 00061506
	v_cvt_f32_i32_sdwa v16, sext(v1) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_1 ; 7e200af9 00090601
	v_cvt_f32_u32_e32 v12, v12                                  ; 7e180d0c
	v_cvt_f32_u32_e32 v9, v9                                    ; 7e120d09
	v_cvt_f16_f32_e32 v8, v7                                    ; 7e101507
	v_cvt_f32_i32_sdwa v18, sext(v1) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_2 ; 7e240af9 000a0601
	v_cvt_f16_f32_sdwa v13, v5 dst_sel:WORD_1 dst_unused:UNUSED_PRESERVE src0_sel:DWORD ; 7e1a14f9 00061505
	v_cvt_f16_f32_e32 v11, v10                                  ; 7e16150a
	v_cvt_f16_f32_e32 v15, v14                                  ; 7e1e150e
	v_cvt_f32_i32_sdwa v1, sext(v1) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:BYTE_3 ; 7e020af9 000b0601
	v_cvt_f16_f32_e32 v17, v16                                  ; 7e221510
	v_cvt_f16_f32_sdwa v11, v12 dst_sel:WORD_1 dst_unused:UNUSED_PRESERVE src0_sel:DWORD ; 7e1614f9 0006150c
	v_cvt_f16_f32_sdwa v8, v9 dst_sel:WORD_1 dst_unused:UNUSED_PRESERVE src0_sel:DWORD ; 7e1014f9 00061509
	v_cvt_f16_f32_e32 v19, v18                                  ; 7e261512
	v_pk_mul_f16 v4, v4, v15 op_sel_hi:[1,0]                    ; d3900004 08021f04
	v_cvt_f16_f32_e32 v20, v1                                   ; 7e281501
	v_pk_fma_f16 v8, v8, v17, v4 op_sel_hi:[1,0,1]              ; d38e4008 0c122308
	v_pk_fma_f16 v11, v11, v19, v8 op_sel_hi:[1,0,1]            ; d38e400b 0c22270b
	v_pk_fma_f16 v13, v13, v20, v11 op_sel_hi:[1,0,1]           ; d38e400d 0c2e290d
	v_cvt_f32_f16_sdwa v21, v13 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 ; 7e2a16f9 0005060d
	v_cvt_f32_f16_e32 v13, v13                                  ; 7e1a170d
	v_add_f32_e32 v13, v13, v21                                 ; 021a2b0d
	ds_write_b32 v0, v13                                        ; d81a0000 00000d00
