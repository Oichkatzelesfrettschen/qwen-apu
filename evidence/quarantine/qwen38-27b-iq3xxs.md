# Withheld model: Qwen3.8-27B UD-IQ3_XXS

```text
id             qwen38-27b-iq3xxs
scope          model
subject        qwen38-27b-iq3xxs
registry tier  archive
role           capacity-experiment
model file     Qwen3.8-27B-GGUF/Qwen3.8-27B-UD-IQ3_XXS.gguf
bytes          10,934,860,704
failure class  archive-capacity-experiment
tuple          unbounded; the withholding covers every geometry of this row
first evidence evidence/model-admission/qwen38-27b-iq3xxs-4k-preflight.log
...
an 11,264 MiB provisional Vulkan allowance and 25.184 GiB of required
MemAvailable, against a 10,428.296 MiB file, on a 29 GiB shared host whose
...
10.18 GiB of appliance disk carry a checkpoint whose admission arm is complete
