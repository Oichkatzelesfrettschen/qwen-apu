...
gate_cell test-census-replay-corpus derive \
    'remote/test-census-replay-corpus.py remote/summarize-kernel-census.py remote/summarize-perf-logger-slice.py remote/validate-clock-sidecar.py' \
...
gate_cell test-telemetry-broker derive \
