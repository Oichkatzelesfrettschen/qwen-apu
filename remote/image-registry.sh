...
# Read the image lane's four authorities: remote/image-artifacts.tsv names the
# files a publisher offers, remote/image-models.tsv binds a set of them into
# one loadable bundle, remote/image-profiles.tsv serves a bundle at one
# placement arm and one bounded geometry, and remote/image-quarantine.tsv
