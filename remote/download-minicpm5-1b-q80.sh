...
# pin reads the publisher's own conversion rather than a third-party quant.
# evidence/model-admission/minicpm5-static-admission.md reads its header over
# an HTTP range request and compares it against the fine-tune before either
# file's weights are fetched by this script.
...
expected_bytes=1153529216
expected_sha256=0dc7638539067268774c275a14a6ec9c7e01f7eeb2cff606c8590361fa527e4c
