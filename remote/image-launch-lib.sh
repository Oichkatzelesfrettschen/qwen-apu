...
require_image_parameters() {
    ...
    # admit-image-router.sh does; a served launch names nothing of the sort.
    ...
    case $image_parameters_resolved in
        ...
        *)
            if [ "${QWEN_IMAGE_PARAMETERS_EXTERNAL:-0}" != 1 ]; then
                ...
                printf 'the served parameter file is %s; a harness writing its own set exports QWEN_IMAGE_PARAMETERS_EXTERNAL=1\n' \
