...
model_path=${QWEN_TRACE_MODEL_PATH:-"$qwen_home_models/Qwen3.8-4B-Distill-GGUF/Qwen3.8-4B-Q4_K_M.gguf"}
trace_build_directory=${QWEN_TRACE_BUILD_DIR:-}
appliance_source=${QWEN_TRACE_APPLIANCE_SOURCE:-"$qwen_home_llama_source"}
...
trace_server_context_sha256=7ef5095ae09986f2d7b244bcf72e0c389a40eab03d8ebf9744f0599218fdbe46
