...
# MTP artifact whose first 10.5 MiB are zero, so its magic, metadata block, and
# tensor index are absent; this fetch names the readable file explicitly rather
# than letting a Q4_K_M preference choose. The artifact is absent from the
# appliance, so the row it feeds enters the tree as a fetch rather than as a
# registry row. The digest is the publisher's own LFS object id at the pinned
# revision.
...
source_repository=DavidAU/Qwen3.5-9B-The-Defiant-Fable-Uncensored-Heretic-NEO-IMATRIX-MAX-MTP-GGUF
source_revision=239d236baf9172e5a4663add74bd34fd297b1c08
source_url=https://huggingface.co/$source_repository/resolve/$source_revision/Qwen3.5-9B-The-Defiant-Fable-Uncnr-Heretic-NEO-MAX-IQ2_M.gguf
expected_bytes=4942441760
expected_sha256=ae9679dee69a4cb3a9375efa3644adc0164a362c61df2b283696d05e57df2fca
