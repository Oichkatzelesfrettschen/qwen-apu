...
withheld_subject=qwen38-9b-distill
...
destination_directory=${1:-"$qwen_home_models/Qwen3.8-9B-Distill-GGUF"}
artifact_name=Qwen3.8-9B-Q4_K_M.gguf
artifact_path=$destination_directory/$artifact_name
partial_path=$artifact_path.part
source_repository=empero-ai/Qwen3.8-9B-Distill-GGUF
source_revision=760121cd70bb4c36b2b5ec58eb765e0df5987efe
source_url=https://huggingface.co/$source_repository/resolve/$source_revision/$artifact_name
expected_bytes=5780090176
expected_sha256=df13d66021cef676f82be74053220fd75af6bf2a6a7fb77f5222ab9e50744a7a
