...
| Kernel-program workstation SPIR-V records | raw exact-target evidence | ordinary Git under `evidence/kernel-program/workstation-spirv/` | `evidence/SHA256SUMS`, `remote/compile-q8-mat-vec-spv.sh` over the pinned commit, and the module digests the manifest names |
